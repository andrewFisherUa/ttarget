...
<div style="color: #0088CC; font-size:14px; font-weight:600;">CPA</div>
        ...
        <div class="campaign-information-header-row1">
            <div class="navbar navbar-white">
                <div class="navbar-inner">
					...
					<?=$this->renderPartial('partials/_nav_menu_admin', array('campaign' => $campaign, 'period' => $period, 'dateFrom' => $dateFrom, 'dateTo' => $dateTo, '_filterUrlParams' => $_filterUrlParams))?>
