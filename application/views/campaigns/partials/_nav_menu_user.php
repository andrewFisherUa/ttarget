...
<ul class="nav">
    ...
    <?else:/*rtb*/?>
        ...
        <li class="<?= $this->action->id == 'statistics' ? 'active' : ''; ?>"><a href="<?= $this->createUrl('/campaigns/statistics', array_merge(array('id' => $campaign->id), $_filterUrlParams)); ?>">Статистика</a></li>
    <?endif;?>
</ul>
