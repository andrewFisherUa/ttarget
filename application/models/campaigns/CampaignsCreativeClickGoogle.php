...
/**
 * This is the model class for table "campaigns_creative_click_goolge".
 *
 * The followings are the available columns in table 'campaigns_creative_click_goolge':
 * @property string $id
 ...
 * @property string $ip
 */
class CampaignsCreativeClickGoogle extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return CampaignsCreativeClickGoolge the static model class
	 */
	...
	{
		return 'campaigns_creative_click_goolge';
	}
	...
	public function addClick( $id )
	{
		...
		$creativeClick = new CampaignsCreativeClickGoolge;
