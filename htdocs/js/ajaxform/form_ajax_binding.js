...
$(function () {
    ...
    function showResponse(responseText, statusText, xhr, $form) {
      //  console.log(responseText);
		if (typeof lastAjaxResponse != "undefined"){
			lastAjaxResponse = responseText;
		}
        ...
        if (responseText.success == true) {
			...
			if(typeof responseText.html != undefined){
				$("#error-note #html").html(responseText.html)
			}
  ...
  //options for the ajax form submission
    ...
    $.submit_ajax = function() {
        $('.modal-body > form:last').ajaxSubmit(options)
    };
